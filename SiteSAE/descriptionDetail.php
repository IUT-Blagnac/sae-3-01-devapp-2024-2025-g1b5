...
<section class="presentation">
    ...
    <div>
        ...
        <div >
            ...
            if($r!= 0  ){
                echo '<label class="prix-produit" style="margin:5px 0; color:red; font-size:1em; text-decoration: line-through;">Prix : ' . htmlspecialchars($r) . ' €</label>';
                echo '<label class="prix-produit" style="margin:5px 0; color:#007BFF; font-size:0.9em; font-weight: bold;">Promo : ' . htmlspecialchars($produit['prix']) . ' €</label>';
