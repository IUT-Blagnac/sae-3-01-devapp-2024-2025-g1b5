...
$prixMin = isset($_POST['prixMin']) ? (int)$_POST['prixMin'] : 0;
$prixMax = isset($_POST['prixMax']) ? (int)$_POST['prixMax'] : 100;
...
$produit = filtrePrix($produit, $prixMin, $prixMax);
...
<div class="page-container">
    <div class="sidebar">
        ...
        <div class="filtrage-container">
            ...
            <br>
            <input type="number" id="prixMin" name="prixMin" min="0" max="100" 
                   value="<?= htmlspecialchars($prixMin) ?>" />
            <br>
            
            <label for="prixMax">Prix max</label>
            <br>
            <input type="number" id="prixMax" name="prixMax" min="0" max="100" 
