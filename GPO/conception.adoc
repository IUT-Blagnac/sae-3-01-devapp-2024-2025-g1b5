...
* xref:I-UseCase[I-Use Case]
* xref:IIDiagrammeClassesMetier[II-Diagramme de Classes métier]
  * xref:DCMU[Diagramme de classe métier pour Utilisateur]
  * xref:DCMA[Diagramme de classe métier pour Administrateur]
* xref:IIIDiagrammeEtatTransition[III-Diagramme d’État transition]
  * xref:DETC[Diagramme d'État-Transition pour la Commande]
  * xref:DETP[Diagramme d'État-Transition pour le Produit]
* xref:IVDiagrammeClasseConception[IV-Diagramme de classe de Conception]
* xref:synthese[Synthèse]
...
. 1. xref:DCMU[Diagramme de classe métier pour Utilisateur]

image::images/DCMU.PNG[]

. 2. xref:DCMA[Diagramme de classe métier pour Administrateur]
...
. 1.1. xref:DETC[Diagramme d'État-Transition pour la Commande]

image::images/DETC.PNG[]

. 1.2. xref:DETP[Diagramme d'État-Transition pour le Produit]
